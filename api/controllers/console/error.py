...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "DoyelAI has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "DoyelAI has not been initialized and installed yet. "
