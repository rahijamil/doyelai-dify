const translation = {
  ...
  intro1: 'Bilgi, DoyelAI uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, DoyelAI dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
