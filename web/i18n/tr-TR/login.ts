const translation = {
  ...
  welcome: 'DoyelAI\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'DoyelAI Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'DoyelAI\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için DoyelAI Enterprise lisansının süresi doldu. DoyelAI\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'DoyelAI lisans sunucusuna bağlanılamadı. DoyelAI\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için DoyelAI Enterprise lisansı etkin değil. DoyelAI\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
