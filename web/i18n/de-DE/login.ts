const translation = {
  ...
  welcome: 'Willkommen bei DoyelAI, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit DoyelAI Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf DoyelAI beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'DoyelAI erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei DoyelAI angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des DoyelAI-Lizenzservers. Wenden Sie sich an Ihren Administrator, um DoyelAI weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die DoyelAI Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um DoyelAI weiterhin zu verwenden.',
  licenseExpiredTip: 'Die DoyelAI Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um DoyelAI weiterhin zu verwenden.',
