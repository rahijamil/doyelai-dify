const translation = {
  ...
  welcome: 'Bem-vindo ao DoyelAI, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do DoyelAI, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no DoyelAI',
  invalid: 'O link expirou',
  explore: 'Explorar o DoyelAI',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no DoyelAI e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do DoyelAI Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o DoyelAI.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças DoyelAI. Entre em contato com o administrador para continuar usando o DoyelAI.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do DoyelAI Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o DoyelAI.',
}
