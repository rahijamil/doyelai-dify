const translation = {
  ...
  welcome: 'Bienvenue sur DoyelAI, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer DoyelAI Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur DoyelAI',
  invalid: 'Le lien a expiré',
  explore: 'Explorez DoyelAI',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur DoyelAI et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence DoyelAI Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser DoyelAI.',
  licenseLostTip: 'Échec de la connexion au serveur de licences DoyelAI. Veuillez contacter votre administrateur pour continuer à utiliser DoyelAI.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence DoyelAI Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser DoyelAI.',
