const translation = {
  ...
  welcome: 'Bine ai venit la DoyelAI, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe DoyelAI și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe DoyelAI. Contactați administratorul pentru a continua să utilizați DoyelAI.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența DoyelAI Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați DoyelAI.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența DoyelAI Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați DoyelAI.',
}
