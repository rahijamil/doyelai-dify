const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a DoyelAI cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a DoyelAI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome DoyelAI Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
