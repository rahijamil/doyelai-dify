const translation = {
  ...
  welcome: 'Dobrodošli v DoyelAI, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z DoyelAI Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na DoyelAI',
  invalid: 'Povezava je potekla',
  explore: 'Razišči DoyelAI',
  ...
  licenseExpiredTip: 'Licenca za DoyelAI Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati DoyelAI, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na DoyelAI, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom DoyelAI ni uspela. Če želite še naprej uporabljati DoyelAI, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca DoyelAI Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati DoyelAI, se obrnite na skrbnika.',
}
