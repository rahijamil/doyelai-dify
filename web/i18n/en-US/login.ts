const translation = {
  ...
  welcome: '👋 Welcome to DoyelAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting DoyelAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on DoyelAI',
  invalid: 'The link has expired',
  explore: 'Explore DoyelAI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on DoyelAI and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The DoyelAI Enterprise license for your workspace has expired. Please contact your administrator to continue using DoyelAI.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect DoyelAI license server. Please contact your administrator to continue using DoyelAI.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The DoyelAI Enterprise license for your workspace is inactive. Please contact your administrator to continue using DoyelAI.',
}
