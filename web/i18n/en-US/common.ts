const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'DoyelAI account',
    langGeniusAccountTip: 'Your DoyelAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to DoyelAI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by DoyelAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across DoyelAI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'DoyelAI {{version}} is now available.',
    latestAvailable: 'DoyelAI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
