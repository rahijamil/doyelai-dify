const translation = {
  ...
  welcome: 'Benvenuto su DoyelAI, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare DoyelAI Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su DoyelAI',
  invalid: 'Il link è scaduto',
  explore: 'Esplora DoyelAI',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su DoyelAI e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze DoyelAI. Contatta il tuo amministratore per continuare a utilizzare DoyelAI.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza DoyelAI Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare DoyelAI.',
  licenseInactiveTip: 'La licenza DoyelAI Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare DoyelAI.',
