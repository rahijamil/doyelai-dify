const translation = {
  ...
  welcome: 'به DoyelAI خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع DoyelAI Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در DoyelAI',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش DoyelAI',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در DoyelAI استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز DoyelAI Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از DoyelAI با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز DoyelAI Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از DoyelAI با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز DoyelAI انجام نشد. لطفا برای ادامه استفاده از DoyelAI با سرپرست خود تماس بگیرید.',
}
