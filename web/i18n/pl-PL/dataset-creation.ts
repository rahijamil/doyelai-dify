const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Obecnie baza wiedzy DoyelAI ma tylko ograniczone źródła danych. Dodanie źródła danych do bazy wiedzy DoyelAI to fantastyczny sposób na zwiększenie elastyczności i możliwości platformy dla wszystkich użytkowników. Nasz przewodnik po wkładach ułatwia rozpoczęcie pracy. Kliknij poniższy link, aby dowiedzieć się więcej.',
  },
}
