const translation = {
  ...
  welcome: 'Witaj w DoyelAI, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej DoyelAI, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na DoyelAI',
  invalid: 'Link wygasł',
  explore: 'Odkryj DoyelAI',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w DoyelAI, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja DoyelAI Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z DoyelAI.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji DoyelAI. Skontaktuj się z administratorem, aby kontynuować korzystanie z DoyelAI.',
  licenseInactiveTip: 'Licencja DoyelAI Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z DoyelAI.',
}
