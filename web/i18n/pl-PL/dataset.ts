const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją DoyelAI ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza DoyelAI i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
