const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto DoyelAI',
    langGeniusAccountTip: 'Twoje konto DoyelAI i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do DoyelAI, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez DoyelAI pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach DoyelAI.',
  ...
  about: {
    ...
    nowAvailable: 'DoyelAI {{version}} jest teraz dostępny.',
    latestAvailable: 'DoyelAI {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
